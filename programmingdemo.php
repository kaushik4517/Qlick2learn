...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/pf.jpg);
}
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2><b style="color: black; font-size: 50px;">PROGRAMMING LANGUAGES</b></h2>
 								<div class="sub-heading" style="color: orange; font-family: lobster;font-size: 20px;">
