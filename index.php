	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: orange;margin-top: 10px;" id="myhead">Qlick2Learn</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="#mycontact_us">contact us</a></li>
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b style="color: black; font-size: 50px;">SERVICES</b></h2>
         				<p style="font-family: lobster ;font-size: 30px; color:orange ">
         					This are the services provided by our Website.
         				</p>
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the notes related to programming languages of all tutorials
         					videos.
...
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				<h2 id="work-heading" class="text-center" style="font-weight: bold;color:black;font-size: 50px;">OUR WORK</h2>
				<p class="text-center" style="font-family: lobster ;font-size: 30px; color:orange ">Join us to improve Your coding skills and works.</p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center">
							<h2><b style="font-weight: bold;color:black;font-size: 50px;">GENERAL FAQs</b></h2>
							<div class="sub-heading">
								<p style="font-family: lobster ;font-size: 30px; color:orange">
									You can ask the about any issues we will <br>solve that together.
								</p>
							...
							<div class="panel-group" id="accordian">
								...
								<?php 
								  ...
								  $con=mysqli_connect('localhost','root');
									...
									mysqli_select_db($con,'qlick2learn');
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												Qlick2Learn is an online E-learning website <br>
												here you can learn programming languages, improve your coding skill.
											</p>
										</div>
									</div>
								</div>
...
<div class="row text-center">
	<h2><b style="font-weight: bold;color:black;font-size: 50px;">CONTACT US</b></h2><br><br>
	<center>
  ...
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted" style="color: orange; font-family: lobster; font-size: 18px;">We'll never share your email with anyone else.</small>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1" style="font-size: 25px;">message</label>
...
<br>
 ...
 <footer>
     <p class="p-3 bg-dark text-white text-center">@Qlick2Learn</p>
 </footer>    
